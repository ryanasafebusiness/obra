      ...
      <div className="glass rounded-2xl p-6 space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-transparent text-muted-foreground">ou</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3.5 rounded-xl bg-surface-elevated border border-border-color text-foreground font-medium text-base hover:bg-surface flex items-center justify-center gap-3 disabled:opacity-50 active:scale-[0.98] transition-transform"
        >
